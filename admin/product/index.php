...
<body>
	...
	<div class="container">
		<div class="panel panel-primary">
			...
			<a href="add.php"><button class="btn btn-primary" style="margin-bottom: 15px;">Them Sản Phẩm</button></a>
...
$offset = ($current_page - 1) * $item_page;
  ...
  $productList = executeResult( "select products.id, products.title, products.price,products.discount, products.thumbnail, products.update_at, category.name category_name  from products left join category on products.id_category = category.id  order by id ASC LIMIT " . $item_page . " OFFSET " . $offset);
